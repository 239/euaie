...
- `:.git/:` or `::.git/` matches all **.git** directories in any location
...
| version       | 1.0.0  | 14.10        | 2.54.0 |
| LOC (cloc)    | 1457   | 49263        | 40722  |
| LOC UI ratio  | 53%    | 47%          | 25%    |
| size (KiB)    | 66     | 2376         | 2115   |
| size UI ratio | 59%    | 50%          | 33%    |
